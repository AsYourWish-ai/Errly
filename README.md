...
> Read **https://raw.githubusercontent.com/AsYourWish-ai/Errly/main/agent_install.md** and do it.
...
```bash
curl -fsSL https://raw.githubusercontent.com/AsYourWish-ai/Errly/main/install.sh | bash
```

Generates an API key, starts the server, and verifies it's healthy — all in one step.
...
```bash
make install   # guided first-time install
